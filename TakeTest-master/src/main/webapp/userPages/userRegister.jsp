    ...
    <div class="contents order-2 order-md-1">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h1>Register as <br><strong><span style="color: #006D77; font-size: 4rem;">User</span></strong></h1>
                    <form action="/TakeTest/VerifyUser" method="post" onsubmit="return validateForm()">
                        ...
                        <input type="submit" value="Verify your email" style="background-color: #006D77; color:#ffffff" class="btn btn-block btn-warning">
                    </form>
